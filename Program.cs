...
namespace CarritoDeCompras
{
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            cliente.Apellidos = "Lopez Parrales";
            cliente.Nombres = "Victor Eduardo";
            cliente.Email = "michael@web.com";
            cliente.Cedula = "1313313134";
            ...
            */
            ...
            impresora.ImprimirDatosCliente(cliente);
